...
namespace Aplicacion_Web2.Controllers
{
    ...
    public class PacienteController : ControllerBase
    {
        ...
        [HttpGet("custom")]
        public async Task<ActionResult<List<Paciente>>> findAllCustom()
        {
            return await context.Paciente.Where(x => x.estadoPaciente == true).ToListAsync(); //Cambiar estado(traer true o false)
        }
